...
# BIMODAL (descubrimiento 2026-05-25): be intermedio (15-35) es valle empirico
# que estorba en Alpha; conviene be=0 (sin lock) o be alto >=40 (lock solo si
# el activo doblo). Excluimos el rango medio explicitamente.
NORMAL_BREAKEVEN = [0.0, 40.0, 50.0, 60.0]
...
EXTREME_BREAKEVEN = [0.0, 70.0, 85.0, 100.0]  # solo "casi-be=0" o bien alto
